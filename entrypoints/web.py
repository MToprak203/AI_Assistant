...
# Global variables to track model loading
model = None
tokenizer = None
model_loaded = False
session_manager = None
web_file_adapter = None
web_chat_adapter = None
container = None
socketio = None


def create_app():
    global container, session_manager, web_file_adapter, web_chat_adapter, socketio
...
def load_model():
    ...
    global model, tokenizer, model_loaded, container
...
def register_socket_events():
    ...
    global socketio, session_manager, web_file_adapter, web_chat_adapter
